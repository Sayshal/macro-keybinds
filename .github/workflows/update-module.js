...
fs.readFile(moduleJsonPath, 'utf8', (err, data) => {
  ...
  moduleJson.manifest = `https://github.com/Sayshal/macro-keybinds/releases/download/${version}/module.json`;
  moduleJson.download = `https://github.com/Sayshal/macro-keybinds/releases/download/${version}/module.zip`;
